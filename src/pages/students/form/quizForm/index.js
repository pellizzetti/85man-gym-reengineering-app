...
const QuizForm = ({
  ...
  <Box>
    ...
    >
      <Box gridArea="healthInsuranceToggle">
        <FormField
          ...
          error={errors.quiz && errors.quiz.has_health_insurance}
        >
      ...
      <Box gridArea="healthInsuranceInput">
        <FormField
          label="Qual?"
          error={errors.quiz && errors.quiz.health_insurance}
        >
          <TextInput
      ...
      <Box gridArea="playSportToggle">
        <FormField
          ...
          error={errors.quiz && errors.quiz.play_sport}
        >
          <Box pad={{ horizontal: 'small', vertical: 'xsmall' }}>
            <RowRadioButtonGroup
    ...
    <FormField
      label="Por que faz academia?"
      error={errors.quiz && errors.quiz.reason_for_doing}
    >
      <Grid
        fill="horizontal"
        columns={{
        ...
        <FieldArray
          ...
          render={arrayHelpers => (
            <>
                  ...
                  <CheckBox
                    ...
                    onChange={event => {
                      if (event.target.checked) {
                        ...
                        const idx = values.quiz.reason_for_doing.indexOf(
                          reason
                        );
              ...
              <FormField
                label="Especifique"
                error={errors.quiz && errors.quiz.other_reason}
              >
                <TextInput
    ...
    <FormField
      ...
      error={errors.quiz && errors.quiz.found_out_through}
    >
      <Grid
        fill="horizontal"
        columns={{
        ...
        <FieldArray
          ...
          render={arrayHelpers => (
            <>
              ...
              <FormField
                label="Qual aluno?"
                error={errors.quiz && errors.quiz.referral}
              >
                <Select
                  name="quiz.referral"
                  labelKey="name"
                  ...
                  options={options}
                  value={
                    (values.quiz.referral && values.quiz.referral.name) || ''
                  }
                  onChange={event =>
                    setFieldValue('quiz.referral', event.value)
                  }
                  onClose={handleClose}
